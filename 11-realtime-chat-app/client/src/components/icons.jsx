...
export const PaperclipIcon = (p) => (
  <svg {...base} {...p}>
    <path d="M21.4 11.1 12 20.5a5 5 0 0 1-7.1-7.1l9-9a3.5 3.5 0 0 1 5 5l-9 9a2 2 0 0 1-2.8-2.8l8-8" />
  </svg>
);
...
export const MessageCircleIcon = (p) => (
  <svg {...base} {...p}>
    <path d="M21 11.5a8.38 8.38 0 0 1-8.5 8.5 8.5 8.5 0 0 1-4-1L3 20l1-5.5a8.38 8.38 0 0 1-1-4A8.5 8.5 0 0 1 11.5 2a8.38 8.38 0 0 1 8.5 8 8.3 8.3 0 0 1 1 1.5z" />
  </svg>
);
