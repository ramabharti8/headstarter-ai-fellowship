...
| 09 | **Smart Search API** | Embeddings · ChromaDB | Semantic search across documents using vector similarity |
| 10 | **AI Email Drafting Tool** | OpenAI · FastAPI | Generates professional email drafts from bullet points |
